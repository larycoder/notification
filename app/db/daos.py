...
class NoteDAO(BaseDAO):
    ...
    def add_note(note_id, note_name, parent_id = None):
        ...
        # add note
        note.note_id = BaseDAO.to_string(note_id)
        note.note_name = BaseDAO.to_string(note_name)
        note.insert_data()
        ...
        if parent_id:
            ...
            relation.parent_id = BaseDAO.to_string(parent_id)
            relation.child_id = BaseDAO.to_string(note_id)
